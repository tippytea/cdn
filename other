/* Files App 0.4.1 - https://www.files.gallery/ */
!function(e) {
    function t(e) {
    ...
    function n(e) {
        return G ? _c.script + "?download_dir_zip=" + encodeURIComponent(e.path) + "&" + e.mtime : "#"
    }
    ...
    var o = {
        a: function(e, t, i) {
            return e ? '<a class="' + t + ' map-link" target="_blank" href="' + m(e) + '" data-lang="google maps"' + (i ? "" : ' title="' + X.get("google maps") + '"') + ">" + (i ? X.get("google maps") : P.get_svg_icon("marker")) + "</a>" : ""
        },
        span: function(e, t) {
            return e ? '<span class="' + t + ' map-link" data-href="' + m(e) + '"' + h("google maps") + ">" + P.get_svg_icon("marker") + "</span>" : ""
        }
    };
    function l(e, t) {
    ...
    function s(e, t) {
        return e.is_dir ? r(e.path) : l(e, t)
    }
    function r(e) {
    ...
    function _(e, t, i) {
        ...
        var a = M(["Model", "ApertureFNumber", "FocalLength", "ExposureTime", "ISOSpeedRatings", "gps"], (function(t) {
            ...
            if ("Model" === t)
                ...
                return o[i || "a"](a, "exif-item exif-gps");
            return '<span class="exif-item exif-' + t + '"' + h(t) + ">" + a + "</span>"
        }
        ));
    ...
    function() {
        if (U.local_storage) {
            ...
            i) {
                ...
                _c.menu_exists || P.clean_localstorage()
        }
    }(),
    function() {
    ...
    var X = function() {
        ...
        var t = !1
          , i = !1
          , a = {}
          , n = ["bg", "da", "de", "en", "es", "et", "fr", "hu", "it", "ja", "ko", "nl", "no", "pl", "pt", "ro", "ru", "th", "zh"];
        if (U.local_storage) {
            ...
            dropdown: function() {
                ...
                if (e && "false" != e && "0" != e) {
                    N.topbar_top.insertAdjacentHTML("beforeend", '<div id="change-lang" class="dropdown' + (t ? " dropdown-lang-loading" : "") + '"><button type="button" class="btn-icon btn-topbar btn-lang" data-text="' + g + '"></button><div class="dropdown-menu dropdown-menu-topbar dropdown-menu-left"><h6 class="dropdown-header" data-lang="language">' + r.get("language") + '</h6><div class="dropdown-lang-items">' + M(n, (function(e) {
                        return '<button class="dropdown-item-lang' + (e === g ? " dropdown-lang-active" : "") + '" data-action="' + e + '"><img src="https://cdn.jsdelivr.net/npm/flag-icon-css@4.1.7/flags/1x1/' + (l[e] || e) + '.svg" class="dropdown-lang-flag"></button>'
                    }
                    )) + "</div></div>");
        ...
        function m(t, i) {
            ...
            _querya("[data-lang]").forEach((function(e) {
                ...
                return e.dataset.tooltip ? e.dataset.tooltip = t : e.title ? e.title = W(t) : void (e.textContent = t)
            }
            )),
    ...
    !function() {
        ...
        q.plugins = {
            ...
            cGF5cGFs: {
                src: ["https://www.paypal.com/sdk/js?client-id=" + (location.search.includes("sandbox") ? "ATKAZeHrlJbh0ecJ7FLpIfWCcviQ4bXXrMVKoXZbhSfX0m3xcWUr32SvF9Or-nDXl7G64KuYE49QrhXk" : "AUI0hrvWgh-soV2Wip8nJC_gpifkvbfoTEM2IPr60DPUY4fYDKtP76aXPWfbmpjlynb2ll6L8jvm5tMN")],
                type: "js"
            },
            uppy: {
        ...
        P.load_plugin = function(e, t, i) {
            ...
            if (a.loaded)
                ...
                t && a.complete.push(t);
                var n = a.src && Array.isArray(a.src[0]);
    ...
    function K() {
        ...
        function o(e, i) {
            var a, n = (e ? '<div class="alert alert-danger" role="alert"><strong>Invalid license</strong><br>You have entered an invalid license key.</div>' : "") + '<div id="pay"><div id="pay_info"><strong>Purchase a license [$39]</strong> to unlock features and support dev!\t\t' + (a = '<div class="license-features">',
            ...
            _id("license_form")), l = o.parentNode, s = _id("license_key"), r = _id("license_save_button"), c = _id("continue_free"), p = _id("pay"), d = _id("pay_pp");
            function m(e) {
            ...
            function u(e) {
                ...
                s.classList.toggle("is-invalid", (i || n) && !a),
            ...
            i && i.Buttons({
                ...
                onApprove: function(e, i) {
                    ...
                    i.order.capture().then((function(e) {
                        m(0),
                        p.innerHTML = "<p><strong>" + e.payer.name.given_name + " " + e.payer.name.surname + "</strong><br>" + e.payer.email_address + "</p><p>Thanks for purchasing! Please check your email.</p>",
                        z("details", e),
                        E.set(t, !0),
                        s.focus();
                        var i = e.purchase_units[0].payments.captures[0].id;
                        i && (s.value || function e() {
                            I({
                                params: "txn_id=" + i,
                                url: S("aHR0cHM6Ly9hcGl4LnBob3RvLmdhbGxlcnkvZmlsZXNfZ2V0X2xpY2Vuc2Vfa2V5LnBocA=="),
                                json_response: !0,
                                complete: (t,i,a)=>{
                                    if (t && i && a && !s.value) {
                                        if (!t.key)
    ...
    function() {
        ...
        var e = function() {
            N.topbar_breadcrumbs.insertAdjacentHTML("afterbegin", '<button id="folder-actions" class="context-button" style="display:none">' + P.get_svg_icon("folder_cog_outline") + "</button>");
            var e = N.topbar_breadcrumbs.firstElementChild;
            return y(e, (t=>P.create_contextmenu(t, "topbar", e, _c.current_dir))),
            e
        }();
        function a(e, i) {
            return '<span class="crumb"><a href="' + r(e) + '" data-path="' + t(e) + '" class="crumb-link">' + i + "</a></span>"
        }
        P.breadcrumbs_info = function() {
            var t = _c.current_dir
              , i = _c.files_count
              , a = i && t.images_count === i ? "images" : i && !t.files_count ? "folders" : "files";
            N.breadcrumbs_info.innerHTML = i + ' <span data-lang="' + a + '" class="breadcrumbs-info-type">' + X.get(a) + "</span>" + (t.dirsize ? '<span class="breadcrumbs-info-size">' + filesize(t.dirsize) + "</span>" : ""),
            j(N.breadcrumbs_info),
            j(e)
        }
        ,
        ...
        function s() {
            ...
            n.length && k(n, (function(n, l) {
                e += e ? "/" + n : n,
                (t.length || n !== o[l]) && (s += a(e, i(n)),
                t.push(l + 1))
            }
            )),
            t.length && (N.breadcrumbs.insertAdjacentHTML("beforeend", s),
            l(function(e, t) {
                for (var i = [], a = e.length, n = 0; n < a; n++) {
                    var o = t(e[n], n);
                    o && i.push(o)
        ...
        N.breadcrumbs.innerHTML = a("", P.get_svg_icon("home")),
        P.set_breadcrumbs = function(t) {
            if (j(e, !0),
            j(N.breadcrumbs_info, !0),
            ...
            o.length) {
                ...
                i.length ? l(i, !0) : (N.breadcrumbs.lastChild.classList.remove("crumb-active"),
                s())
            } else
                s()
        }
    ...
    function() {
        ...
        function r(e, t, i, a, n) {
            return a ? '<button class="dropdown-item' + (n ? " " + n : "") + '" data-action="' + i + '">' + (t ? P.get_svg_icon(t) : "") + X.span(e, !0) + "</button>" : ""
        }
        var c = Object.assign({
            javascript: !0,
            current_dir_only: !0
        ...
        function m(t) {
            if (t != e.is_open) {
                ...
                document.documentElement[i]("click", p),
                document[i]("contextmenu", p),
                document[i]("visibilitychange", p),
                window[i]("blur", p),
                window[i]("scroll", p),
                q.popup && q.popup.topbar && q.popup.topbar[i]("click", p),
                N.sidebar_menu && N.sidebar_menu[i]("scroll", p)
            }
        ...
        P.create_contextmenu = function(p, d, u, f, v) {
            if ((_c.context_menu || "topbar" === d) && u && f) {
                if (e.is_open) {
                    if (u == e.el)
                ...
                p.stopPropagation(),
                u === e.el && f === e.item || (a.innerHTML = '<h6 class="dropdown-header" title="' + t(f.basename) + '">' + ("files" === d ? P.get_svg_icon_files(f) : "") + i(f.basename) + "</h6>" + r("zoom", null, "popup", "popup" !== d && f.browser_image && f.is_readable) + r("open", null, "folder", "sidebar" !== d && f.is_dir && f !== _c.current_dir) + r("show info", null, "modal", !["modal", "popup"].includes(d)) + function(e, t) {
                    var i = !!e && s(e);
                    return i && "#" !== i ? '<a class="' + t + '" href="' + i + '" target="_blank" data-lang="open in new tab">' + X.get("open in new tab") + "</a>" : ""
                }(f, "dropdown-item") + r("copy link", null, "clipboard", U.url && U.clipboard && f.url_path) + function(e, t) {
                    return U.download && !e.is_dir && e.is_readable ? '<a href="' + l(e, !0) + '" class="' + t + '" data-lang="download" download>' + X.get("download") + "</a>" : ""
                }(f, "dropdown-item") + o.a(f.gps, "dropdown-item", !0) + function(e) {
                    if (!(U.download && _c.download_dir && e.is_dir && e.is_readable))
                        return "";
                    var i = e.hasOwnProperty("files_count") ? e : _c.dirs[e.path];
                    return !i || c.current_dir_only && i !== _c.current_dir || "files" === _c.download_dir && (!i.files_count || !U.is_pointer) || i.hasOwnProperty("files_count") && !i.files_count ? "" : "zip" !== _c.download_dir || c.javascript ? '<button class="dropdown-item fm-action" data-action="download_dir">' + P.get_svg_icon("tray_arrow_down") + X.span("download", !0) + '&nbsp;<span class="no-pointer">' + ("zip" === _c.download_dir ? "Zip" : X.get("files")) + "</span></button>" : '<a href="' + n(i) + '" class="dropdown-item fm-action" data-action="download_dir" download="' + (G ? t(e.basename) + ".zip" : "") + '">' + P.get_svg_icon("tray_arrow_down") + X.span("download", !0) + '&nbsp;<span class="no-pointer">Zip</span></a>'
                }(f) + function() {
                    if ("popup" === d || !f.is_writeable)
                        return "";
                    var e = r("delete", "close_thick", "delete", _c.allow_delete && f.path, "fm-action") + r("new folder", "plus", "new_folder", _c.allow_new_folder && f.is_dir, "fm-action") + r("new file", "plus", "new_file", _c.allow_new_file && f.is_dir, "fm-action") + r("rename", "pencil_outline", "rename", _c.allow_rename && f.path, "fm-action") + r("duplicate", "plus_circle_multiple_outline", "duplicate", _c.allow_duplicate && !f.is_dir, "fm-action") + r("upload", "tray_arrow_up", "upload", q.uppy && f.is_dir, "fm-action");
                    return e ? '<div class="context-fm">' + e + "</div>" : ""
                }()),
                a.style.display = "block";
                var g = u.getBoundingClientRect()
                  , _ = (u.clientHeight > 50 ? p.clientY : g.top) - a.clientHeight - 10
                  , h = u.clientHeight > 50 ? p.clientY + 20 : g.bottom + 10
                  , x = _ >= 0
                  , b = !x && h + a.clientHeight <= document.documentElement.clientHeight;
                a.style.top = Math.round(b ? h : Math.max(0, _)) + "px";
                var y = (u.clientWidth > 100 ? p.clientX : g.left + u.offsetWidth / 2) - a.clientWidth / 2
                  , w = Math.max(10, Math.min(document.documentElement.clientWidth - a.clientWidth - 10, y));
                a.style.left = Math.round(w) + "px",
                a.style.setProperty("--offset", Math.round(Math.max(10, Math.min(a.clientWidth - 10, a.clientWidth / 2 - w + y))) + "px"),
                a.classList.toggle("cm-top", x),
                a.classList.toggle("cm-bottom", b),
                a.classList.toggle("cm-border", "sidebar" === d),
                e.el = u,
                e.item = f,
                e.a = v || !1,
                m(!0),
        ...
        d(a, (function(t, i) {
            if (ae[t])
                ...
                q.uppy.getPlugin("Dashboard").openModal();
            else if ("popup" === t)
                _c.history && q.modal.open && q.modal.popstate.remove(),
                P.open_popup(e.item);
            else if ("folder" === t)
                q.modal.open && P.close_modal(),
                P.get_files(e.item.path, "push");
            else if ("modal" === t)
                P.open_modal(e.item, !0);
            else if ("clipboard" === t)
                l = s(e.item),
                (r = new URL(l,location)) && x(r.href);
            else if ("download_dir" === t) {
                if (G && "zip" === _c.download_dir && !c.javascript)
                    return;
                if (i.preventDefault(),
                !G)
                    return te.fire();
                if ("zip" === _c.download_dir) {
                    var a = !0;
                    Swal.fire({
                        title: X.get("download", !0) + ' zip <span class="swal-percent"></span>',
                        toast: !0,
                        showConfirmButton: !1,
                        ...
                        didOpen: ()=>{
                            Swal.showLoading();
                            var t = Swal.getContainer().getElementsByClassName("swal2-timer-progress-bar")[0]
                              , i = Swal.getContainer().getElementsByClassName("swal-percent")[0];
                            new jsFileDownloader({
                                ...
                                process: function(e) {
                                    if (e.lengthComputable) {
                                        ...
                                        i.textContent = Math.round(100 * n) + "%",
                                        e.loaded > 0 && a && (a = !1,
                                        Swal.hideLoading(),
                                        t.style.display = "block")
                                    }
                                },
                                filename: e.item.basename + ".zip"
                            }).then((function() {
                                Swal.close()
                            }
                            )).catch((function(e) {
                    ...
                    var o = e.item.files || (_c.dirs[e.item.path] || {}).files || {};
                    if (downloadables = [],
                    index = 0,
                    Object.keys(o).forEach((e=>{
                        var t = o[e];
                        !t.is_dir && t.url_path && downloadables.push(encodeURI(t.url_path))
                    }
                    )),
                    ...
                    !function e() {
                        new jsFileDownloader({
                            ...
                            index++ < downloadables.length - 1 && e()
                        }
                        ))
                    }()
                }
    ...
    function() {
        ...
        function a(i) {
            i.classList.contains("touch-open") ? e && e.remove() : e = C(document, t, (function(t) {
      ...
      , ae = function() {
        function e(e, t, i, o) {
            ...
            var l = !!_c.files[t.basename] && q.list.get("path", t.path)[0]
              , s = !!l && a(l.elm)
              , r = !(!t.is_dir || !N.sidebar_menu) && ("" === t.path ? N.sidebar_menu : a(_query('[data-path="' + n(t.path) + '"]', N.sidebar_menu)))
        ...
        function s(e) {
            ...
            var t = e.split("/")
              , i = t.pop("/");
            return '<span class="swal-files-path">' + (t.length ? t.join("/") + "/" : "") + '<span class="swal-files-name' + (t.length ? " swal-files-has-path" : "") + '">' + i + "</span></span>"
        }
        return {
                ...
                J.fire({
                    ...
                    inputValidator: e=>{
                        ...
                        if (_c.files[t.basename] && _c.files[t.basename].path === t.path) {
                            ...
                            if (_c.dirs[o(a, e)])
                                return "Folder already existsA"
                        }
                    }
                }).then((i=>{
                    if (i.isConfirmed && i.value && i.value !== t.basename) {
                        var a = i.value;
                        e("rename", t, "&name=" + encodeURI(a), (function(e, i, s, r) {
                            $.fire({
                                title: a
                            });
                            var c = t.basename
                              , p = t.path
                              , d = o(r ? r.path : p.split("/").slice(0, -1).join("/"), a)
                              , m = !!r && o(r.url_path, a);
                            if (r) {
                                if (r === _c.current_dir && r.files) {
                                    ...
                                    if (i && i.isConnected) {
                                        i.setAttribute("href", l(u, "download" === _c.click)),
                                        i.dataset.name = a,
                                        _class("name", i)[0].textContent = a;
                                        var f = i.firstElementChild;
                                        if (!t.is_dir && "IMG" === f.nodeName) {
                                            var v = _c.script + "?file=" + encodeURIComponent(u.path) + "&resize=" + (U.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina ? _c.image_resize_dimensions_retina : _c.image_resize_dimensions) + "&" + (new Date).getTime();
                                            f.dataset.src = v,
                            ...
                            t.is_dir && (Object.keys(_c.dirs).filter((e=>e.startsWith(p))).forEach((function(e) {
                                ...
                                if (e === p && (o.basename = a),
                                delete _c.dirs[e],
                                E.remove(le(e, o.mtime)),
                                N.sidebar_menu) {
                                    var s = _query('[data-path="' + n(e) + '"]', N.sidebar_menu);
                                    s && (e === p && (s.firstElementChild.lastChild.textContent = a),
                                    s.dataset.path = i,
                                    s.firstElementChild.setAttribute("href", l(o)))
                                }
                            }
                            )),
                            _c.current_path && _c.current_path.startsWith(p) && P.get_files(_c.current_dir.path, "push"))
                        }
                        ))
                    }
                }
            ...
            new_folder: function(a) {
                ...
                J.fire({
                    ...
                    inputValidator: e=>{
                        var t = e.match(/[<>:"'/\\|?*#]|\.\.|\.$/g);
                        return t ? "Invalid characters " + t.join(" ") : _c.dirs[o(a.path, e)] || _c.dirs[a.path] && _c.dirs[a.path].files && _c.dirs[a.path].files[e] ? "Folder exists" : void 0
                    }
                }).then((n=>{
                    if (n.isConfirmed && n.value) {
                        var s = n.value;
                        e("new_folder", a, "&name=" + encodeURI(s), (function(e, n, r, c) {
                            if ($.fire({
                                title: s
                            }),
                            _c.menu_enabled && !_c.menu_exists)
                                return window.location.reload();
                            var p = _c.dirs[a.path];
                            if (p) {
                                if (delete p.files,
                                delete p.html,
                                delete p.json_cache,
                                E.remove(le(p.path, p.mtime)),
                                r) {
                                    var d = o(p.path, s)
                                      , m = _c.dirs[d] = {
                                        basename: s,
                                        path: d,
                                        url_path: o(p.url_path, s),
                                        is_dir: !0,
                                        is_writeable: !0,
                                        is_readable: !0,
                                        filetype: "dir",
                                      ...
                                      , v = '<li data-level="' + (f + 1) + '" data-path="' + t(d) + '" class="menu-li"><a href="' + l(m) + '" class="menu-a">' + P.get_svg_icon_class("folder", "menu-icon menu-icon-folder") + i(s) + "</a></li>";
                                    u ? u.insertAdjacentHTML("afterbegin", v) : (r.firstElementChild.firstElementChild.remove(),
                                    r.firstElementChild.insertAdjacentHTML("afterbegin", P.get_svg_icon_multi_class("menu-icon menu-icon-toggle", "plus", "minus") + P.get_svg_icon_multi_class("menu-icon menu-icon-folder menu-icon-folder-toggle", "folder", "folder_plus", "folder_minus")),
                                    r.classList.add("has-ul"),
                                    r.insertAdjacentHTML("beforeend", '<ul style="--depth:' + f + '" class="menu-ul">' + v + "</ul>")),
                                    m.menu_li = r.lastElementChild.firstElementChild
                                }
                                p === _c.current_dir && P.get_files(_c.current_path, "replace", !0)
                            }
                        }
                        ))
                    }
            ...
            delete: function(t) {
                ie.fire({
                    ...
                    i.isConfirmed && e("delete", t, null, (function(e, i, a, n, o) {
                        ...
                        n.preview === t.basename && (delete n.preview,
                        n.path)) {
                            var l = n.path.split("/").slice(0, -1).join("/");
                            _c.dirs[l] && delete _c.dirs[l].html
                        }
                        ...
                        t.is_dir) {
                            ...
                            _c.current_path && _c.current_path.startsWith(t.path) && P.get_files(n.path, "replace")
                        }
                    }
                    ))
                }
    ...
    _c.allow_upload && P.load_plugin("uppy", (function() {
        ...
        function a(e) {
            P.load_plugin("uppy_locale_" + e, (function() {
                ...
                src: ["@uppy/locales@2.4.1/dist/" + e + ".min.js"]
            })
        }
    ...
    !function() {
        var e = !1
          , n = U.pixel_ratio >= 1.5 && _c.image_resize_dimensions_retina ? _c.image_resize_dimensions_retina : _c.image_resize_dimensions
          , l = !!_c.x3_path && _c.x3_path + (_c.x3_path.endsWith("/") ? "" : "/") + "render/w" + (U.pixel_ratio >= 1.5 ? "480" : "320") + "/";
        function r(t, i) {
            if (e)
                return e.abort(),
                e = !1,
        ...
        function c(e, t, i) {
            ...
            i && _c.history && history[i + "State"]({
                ...
                return p || "replace" !== e || !_c.query_path && t ? (p = !0,
            ...
            return _c.current_dir.html = M(_c.file_names, (function(e, r) {
                ...
                var d, m = function() {
                    if (c.mime1) {
                                    ...
                                    if (_c.image_resize_enabled && e.dimensions && e.mime1 && e.image && _c.resize_image_types.includes(e.mime1)) {
                                        ...
                                        if ((!t.type || image_resize_types.includes(t.type)) && !(i < image_resize_min_ratio || _c.image_resize_max_pixels && a > _c.image_resize_max_pixels)) {
                                            if (_c.image_resize_memory_limit) {
                                                var o = t.width / i
                                                  , l = t.height / i;
                                                if ((a * (t.bits ? t.bits / 8 : 1) * (t.channels || 3) * 1.33 + o * l * 4) / 1048576 > _c.image_resize_memory_limit)
                                                    return
                                            }
                                            return !0
                                        }
                        ...
                        return "video" === c.mime0 && (B("video", c) && (c.is_browser_video = !0,
                ...
                '<a href="' + s(c, "download" === _c.click) + '" target="_blank" class="files-a files-a-' + (m ? "img" : "svg") + '"' + (c.preview_ratio ? ' style="--ratio:' + c.preview_ratio + '"' : "") + ' data-name="' + t(c.basename) + '"' + (c.is_dir || "download" !== _c.click ? "" : " download") + ">" + (m || P.get_svg_large(c, "files-svg")) + '<div class="files-data">' + o.span(c.gps, "gps") + a(i(c.basename), "name") + (c.image && c.image.iptc && c.image.iptc.title ? a(-1 === (d = c.image.iptc.title).indexOf("<a") ? d : d.replace(/<a\s/g, "<span ").replace(/<\/a>/g, "</span>").replace(/\shref\=/g, " data-href="), "title") : "") + a(P.get_svg_icon_files(c), "icon") + u(c.dimensions, "dimensions") + f(c, "size") + _(c.image, "exif", "span") + a(c.ext ? a(c.ext, "ext-inner") : "", "ext") + a(P.get_time(c, "ll", "llll", !1), "date") + '<span class="flex"></span></div>' + v("menu" !== _c.click || c.is_dir, "files-context") + D(c) + "</a>"
            }
            ))
        }
        function g(e, t, i) {
            ...
            j(N.sortbar, !_c.files_count),
            _c.files_count && (N.files.innerHTML = _c.current_dir.html || m(),
            oe.create(),
            "push" !== t && oe.hash(!0),
            P.set_sort(),
        ...
        P.get_files = function(t, i, a) {
            if (a || t !== _c.current_path) {
                ...
                oe.clear(),
                a || P.set_breadcrumbs(t),
                !a && _c.menu_exists && P.set_menu_active(t);
                var n = _c.dirs[t];
                if (!a && n) {
                    if (n.files)
                        return r(!1, (function() {
                    ...
                    if (o)
                        ...
                        r(!1, (function() {
                            oe.empty(),
                            g(t, i, "files from localStorage")
                        }
                        ))
                }
                oe.disabled(!0),
                _c.menu_exists && P.menu_loading(!1, !0),
                ...
                e = I({
                    ...
                    always: ()=>{
                        e = !1,
                        _c.menu_exists && P.menu_loading(!1, !1),
                        N.topbar.classList.remove("topbar-spinner")
                    }
                    ,
                    complete: function(e, a, n) {
                        return n ? e.error ? x(e.error + " " + t, t, i) : (h(t, e),
            ...
            function c(e) {
                1 == l++ && g(t, i, s ? "files from JSON " + s : "files from xmlhttp")
            }
        }
        ,
        P.init_files = function() {
            if (_c.query_path)
                return _c.query_path_valid ? P.get_files(_c.query_path, "replace") : x("Invalid directory " + _c.query_path, _c.query_path, "replace");
            if (location.search) {
                ...
                if (e && "debug" !== e && (-1 === e.indexOf("=") || e.indexOf("/") > -1)) {
                    ...
                    return t && t.is_dir && h(_c.query_path, t),
                    P.get_files(_c.query_path, "replace")
                }
            }
            P.get_files(_c.init_path, "replace")
        }
        ,
        d(N.topbar_info, (function(e, t) {
            if ("reset" === e)
                return oe.clear(!0)
        }
        )),
    ...
    function() {
        ...
        function j(e) {
            s.layout !== e && (p.innerHTML = P.get_svg_icon("layout_" + e),
        ...
        y(C, (function(e) {
            _c.files_count <= z && N.files.style.setProperty("--" + s.layout + "-space-factor", C.value)
        }
        ), "input"),
        y(C, (function(e) {
    ...
    function() {
        var e, t, a, n = q.popup = {
            ...
            playing: !1,
            timer: !1
        }, o = E.get("files:popup:locked_caption"), s = screen.width < 375 ? "ll" : screen.width < 414 ? "lll" : "llll", r = screen.width >= 576, p = {
            caption_hide: !0,
            caption_style: "block",
            ...
            getDoubleTapZoom: function() {
                return n.toggle_play(!1),
                1
            },
            getThumbBoundsFn: function(t, i) {
                var a = e.items[t]
                  , n = q.modal.open ? q.modal.item === a.item && _class("modal-image", N.modal)[0] : a.img_el;
            ...
            index: 0,
            addCaptionHTMLFn: function(e, a) {
                var o = e.item;
                if ("topbar" === p.caption_style)
                    return n.search.innerHTML = o.basename,
                    !1;
                if (!N.filter.value) {
                    if ("video" === e.type)
                        return n.search.innerHTML = o.basename,
                ...
                return o.hasOwnProperty("popup_caption") || (o.popup_caption = v(U.PointerEvent, "popup-context") + '<div class="popup-basename">' + i(o.basename) + "</div>" + u(o.dimensions, "popup-dimensions") + f(o, "popup-filesize") + '<span class="popup-date">' + P.get_time(o, s, "LLLL", r) + "</span>" + _(o.image, "popup-exif") + g(o.image, "popup")),
                o.popup_caption ? (n.caption_transition_delay && (n.caption.style.cssText = "transition: none; opacity: 0",
                t && clearTimeout(t),
                t = setTimeout((function() {
                    n.caption.style.cssText = "transition: opacity 333ms cubic-bezier(0.33, 1, 0.68, 1)",
                    t = setTimeout((function() {
                ...
                !0) : ce.resetEl(n.caption_center)
            }
        };
        function d(t) {
            t !== e.options.showHideOpacity && (e.options.showHideOpacity = t,
            ce.toggle_class(n.pswp, "pswp--animate_opacity", t))
        }
        function m(t) {
            var i = !!(n.current_video && n.is_open && e && e.itemHolders) && n.current_video.firstElementChild;
        ...
        _c.config && _c.config.popup && (Object.assign(p, _c.config.popup),
        p.play_transition || (p.play_transition = p.transition || "glide"),
        p.transitions && Object.assign(n.transitions, p.transitions)),
        P.open_popup = function(t, o) {
            if (t && q.list.items.length && !n.is_open) {
                var s = {
                    index: 0
                };
                if (a === q.list.matchingItems) {
                    ...
                    a = q.list.matchingItems,
                    n.slides = [],
                    a.forEach((function(e, i) {
                        var a = e._values;
                        if (a && a.is_readable && a.is_popup) {
                            if (a.browser_image) {
                                var o = !!_c.load_images && e.elm.firstElementChild
                                  , r = !U.image_orientation && T(a.image)
                                  , c = o && !r
                                  , p = {
                                    type: "image",
                                    src: l(a),
                                    ...
                                    img_el: o,
                                    msrc: !(!c || !o.complete) && o.getAttribute("src"),
                                    item: a
                                };
                                if (r && (p.w = a.image.height,
                                p.h = a.image.width),
                                c && !p.msrc && (o.onload = function() {
                            ...
                            } else if (a.is_browser_video)
                                p = {
                                    type: "video",
                                    html: '<video class="popup-video" playsinline disablepictureinpicture controls controlsList="nodownload"><source src="' + l(a) + '" type="' + a.mime + '"></video>',
                                    pid: encodeURIComponent(a.basename),
                                    item: a
                                };
                            a === t && (s.index = n.slides.length),
                            n.slides.push(p)
                        }
                    }
                    ));
                ...
                n.container.style.cursor = n.slides.length > 1 ? "pointer" : "default",
                "topbar" !== p.caption_style && N.filter.value && (n.search.innerHTML = P.get_svg_icon("image_search_outline") + '"' + i(N.filter.value) + '"'),
                n.slides.length < 3 && (s.playEl = !1),
                e = new pe(n.pswp,re,n.slides,Object.assign({}, p, s, {
                    arrowEl: n.slides.length > 1 && !U.only_touch,
                    arrowKeys: n.slides.length > 1,
                    counterEl: n.slides.length > 1,
                    showAnimationDuration: o ? 0 : 333,
                    showHideOpacity: !n.slides[s.index].msrc && !o
                })),
                U.is_touch && e.listen("zoomGestureEnded", (function() {
                    e.getZoomLevel() > e.currItem.initialZoomLevel && n.toggle_play(!1)
                }
                )),
                e.listen("beforeChange", (function() {
                    x("video" == e.currItem.type && e.currItem.container),
                    n.toggle_timer(!1)
                }
                )),
                e.listen("afterChange", (function() {
                    n.ui.classList.toggle("popup-ui-video", "video" == e.currItem.type),
                    n.toggle_timer(!0)
                }
                )),
                t.is_browser_video && _c.video_autoplay && e.listen("initialZoomInEnd", (function() {
                    m("play")
                }
                )),
        ...
        n.toggle_play = function(e) {
            e === n.playing || e && b() || (n.playing = !!e,
            ce.toggle_class(n.play_button, "is-playing", e),
            n.toggle_timer(e))
        }
        ,
        ...
        ,
        document.body.insertAdjacentHTML("beforeend", '\t\t<div class="pswp' + (U.is_touch ? " pswp--touch" : "") + (U.only_pointer ? " pswp--has_mouse" : "") + '" tabindex="-1" role="dialog" aria-hidden="true">\t    \t<div class="pswp__bg"></div>\t    \t<div class="pswp__scroll-wrap">\t    \t\t<div class="pswp__container' + (_c.server_exif ? " server-exif" : "") + '">\t\t        <div class="pswp__item"></div>\t\t        <div class="pswp__item"></div>\t\t        <div class="pswp__item"></div>\t        </div>\t        <div class="pswp__ui pswp__ui--hidden pswp__caption-align-' + p.caption_align + '">\t          <div class="pswp__top-bar">\t            <div class="pswp__counter"></div>\t            <div class="pswp__search"></div>\t            <div class="pswp__topbar-spacer"></div>\t            <svg viewBox="0 0 18 18" class="pswp__preloader svg-preloader"><circle cx="9" cy="9" r="8" pathLength="100" class="svg-preloader-circle"></svg>' + (p.downloadEl ? '<a type="button" class="pswp__button pswp__button--download"' + h(U.download ? "download" : "open in new tab") + ' target="_blank"' + (U.download ? " download" : "") + ">" + P.get_svg_icon(U.download ? "download" : "open_in_new") + "</a>" : v(!0, "pswp__button pswp__button--contextmenu")) + (U.only_touch ? "" : '<button class="pswp__button pswp__button--zoom">' + P.get_svg_icon_multi("zoom_in", "zoom_out") + "</button>") + '\t            <button class="pswp__button pswp__button--play">' + P.get_svg_icon_multi("play", "pause") + "</button>\t            " + (U.fullscreen ? '<button class="pswp__button pswp__button--fs">' + P.get_svg_icon_multi("expand", "collapse") + "</button>" : "") + '\t            <button class="pswp__button pswp__button--close">' + P.get_svg_icon("close") + '</button>\t          </div>\t          <button class="pswp__button pswp__button--arrow--left">' + P.get_svg_icon("chevron_left") + '</button><button class="pswp__button pswp__button--arrow--right">' + P.get_svg_icon("chevron_right") + '</button>\t          <div class="pswp__timer"></div>\t          <div class="pswp__caption pswp__caption-style-' + p.caption_style + (p.caption_hide ? " pswp__caption-hide" : "") + (o ? " pswp__caption-locked" : "") + '">\t          \t' + (U.only_touch ? "" : '<button class="pswp__button pswp__button--lock-caption">' + P.get_svg_icon_multi("lock_outline", "lock_open_outline") + "</button>") + '\t          \t<div class="pswp__caption__center"></div>\t          </div>\t        </div>\t    \t</div>\t\t\t</div>'),
        n.pswp = document.body.lastElementChild,
        n.bg = n.pswp.firstElementChild,
        n.scrollwrap = n.pswp.lastElementChild,
        ...
        Array.from(n.topbar.children).forEach((function(e) {
            var t = e.classList;
            return t.contains("pswp__preloader") ? n.preloader = e : t.contains("pswp__button--play") ? n.play_button = e : t.contains("pswp__search") ? n.search = e : t.contains("pswp__button--contextmenu") ? n.contextmenu_button = e : void 0
        }
        )),
        n.caption.addEventListener("click", (function(t) {
            return t.target.classList.contains("pswp__button--lock-caption") ? (o = !o,
            ce.toggle_class(n.caption, "pswp__caption-locked", o),
            E.set("files:popup:locked_caption", o, !0)) : "context" == t.target.dataset.action ? P.create_contextmenu(t, "popup", t.target, e.currItem.item) : void (U.is_pointer && 0 === t.target.className.indexOf("pswp") && ("right" === p.caption_align && t.pageX > this.clientWidth - 49 ? e.next() : "left" === p.caption_align && t.pageX < 49 && e.prev()))
        }
        )),
        U.is_pointer && n.contextmenu_button && y(n.contextmenu_button, (function(t) {
            P.create_contextmenu(t, "popup", t.target, e.currItem.item)
        }
        ))
    }(),
    function() {
    ...
    !function() {
        var e = {};
        N.modal.innerHTML = '<div class="modal-dialog" role="document">\t  <div class="modal-content">\t    <div class="modal-header">\t      <h5 class="modal-title"></h5>\t      <div class="modal-buttons">\t      \t<div class="modal-code-buttons" style="display: none">' + (_c.allow_text_edit ? '<button type="button" class="btn btn-1 is-icon" data-action="save" data-tooltip="' + X.get("save") + '" data-lang="save">' + P.get_svg_icon("save_edit") + "</button>" : "") + '<button type="button" class="btn ' + 'btn-1 is-icon" data-action="copy" data-tooltip="' + X.get("copy text") + '" data-lang="copy text">' + P.get_svg_icon("clipboard") + '</button><button type="button" class="btn ' + 'btn-1 is-icon" data-action="fullscreen">' + P.get_svg_icon_multi("expand", "collapse") + '</button></div><button class="btn btn-1 is-icon" data-action="close"' + h("close") + ">" + P.get_svg_icon("close") + '</button>\t      </div>\t    </div>\t    <div class="modal-body"></div>\t  </div>\t</div>';
        ...
        P.open_modal = function(n, r) {
            ...
            !n.is_dir && n.is_readable)
                if (n.browser_image)
                    ...
                    c = '<img data-action="zoom" src="' + l(n) + '" class="modal-image files-img-placeholder' + ("ico" == n.ext ? " modal-image-ico" : "") + '"' + (!n.dimensions || !_c.server_exif && U.image_orientation || !U.image_orientation && T(n.image) ? "" : ' width="' + n.dimensions[0] + '" height="' + n.dimensions[1] + '" style="--ratio:' + n.ratio + '"') + "></img>";
                else if (n.is_browser_video)
                    q.modal.type = "video",
                    c = '<video src="' + l(n) + '" type="' + n.mime + '" class="modal-video" controls playsinline disablepictureinpicture controlslist="nodownload"' + (_c.video_autoplay ? " autoplay" : "") + "></video>";
                else if (_c.video_thumbs_enabled && "video" === n.mime0 && n.is_readable)
                    q.modal.type = "video-thumb",
                    c = '<img src="' + _c.script + "?file=" + encodeURIComponent(n.path) + "&resize=video&" + _c.image_cache_hash + "." + n.mtime + "." + n.filesize + '" class="modal-image files-img-placeholder" width="' + n.preview_dimensions[0] + '" height="' + n.preview_dimensions[1] + '" style="--ratio:' + n.preview_ratio + '"></img>';
                else if (B("audio", n))
                    q.modal.type = "audio",
                    c = P.get_svg_large(n, "modal-svg") + '<audio src="' + l(n) + '" type="' + n.mime + '" class="modal-audio" controls playsinline controlslist="nodownload"></audio>';
                else {
                    if (!n.hasOwnProperty("code_mode")) {
                        ...
                        n.code_mode = h && h.mode || !1
                    }
                    n.code_mode && (q.modal.type = "code",
                    n.filesize > 1e3 && (d = !0),
                    P.load_plugin("codemirror"),
                    c = '<div class="spinner-border modal-preview-spinner"></div>' + P.get_svg_large(n, "modal-svg"))
                }
            c || (c = P.get_svg_large(n, "modal-svg") + D(n));
            var x = ["image", "file"].includes(q.modal.type) || "dir" === q.modal.type && n.url_path ? "a" : "div"
              , b = "<" + ("a" === x ? 'a href="' + l(n) + '" target="_blank" title="' + X.get("image" === q.modal.type ? "zoom" : "open in new tab") + '"' : "div") + ' class="modal-preview modal-preview-' + q.modal.type + '">' + c + "</" + x + '><div class="modal-info">' + v(!0, "modal-info-context") + '<div class="modal-info-name">' + i(n.basename) + '</div>\t\t\t<div class="modal-info-meta">' + (n.mime ? '<span class="modal-info-mime">' + P.get_svg_icon_files(n) + n.mime + "</span>" : "") + u(n.dimensions, "modal-info-dimensions") + f(n, "modal-info-filesize") + function(e, t) {
            ...
            }(n, "modal-info-permissions") + '</div>\t\t\t<div class="modal-info-date">' + P.get_svg_icon("date") + P.get_time(n, "llll", "LLLL", !0) + "</div>" + _(n.image, "modal-info-exif") + g(n.image, "modal-info", !0) + "</div>";
            t.classList.toggle("modal-lg", d),
            a.classList.add("modal-content-" + q.modal.type),
            o.innerText = n.basename,
            U.is_pointer && (o.title = n.basename),
            m.innerHTML = b;
            var w, k = !!n.browser_image && _class("files-img-placeholder", m)[0];
            ...
            q.modal.popstate = C(window, "popstate", (function() {
                P.close_modal()
            }
            ))),
            w = function() {
                    ...
                    e.file = I({
                        ...
                        complete: function(i) {
                            ...
                            P.load_plugin("codemirror", (function() {
                                if (q.modal.open === t) {
                                    p(_class("modal-preview-spinner", m));
                                    var e = _class("modal-preview-code", m)[0];
                                    e && (p(_class("modal-svg", m)),
                                    ...
                                    q.modal.resize_listener = C(window, "resize", y),
                                    s.style.display = "")
                                }
                            }
                            ))
        ...
        function M(e, t) {
            k = !1,
            r.classList.remove("tooltip-loading"),
            R.timer(r, t, e ? "success" : "danger")
        }
        function V(e) {
            if (!k && !r.disabled) {
                if (_c.demo_mode)
                ...
                k = !0,
                r.classList.add("tooltip-loading");
                var t = _c.current_dir;
                I({
    ...
    var re = function(e, t) {
        var i, a, n, o, l, s, r, c, p, d, u, f, v, g, _, h, x, b = this, y = !1, w = !0, C = {
            timeToIdle: 3e3,
            ...
            u !== e && (t.toggle_class(d, "svg-preloader-active", !e),
            u = e)
        }, E = [{
            name: "caption",
            option: "captionEl",
        ...
        b.init = function() {
            ...
            p("beforeChange", (function() {
                ...
                f = setTimeout((function() {
                    e.currItem && e.currItem.loading ? e.currItem.img && !e.currItem.img.naturalWidth && A(!1) : A(!0)
                }
      ...
      , pe = function(e, t, i, a) {
        ...
        Object.assign(o, a);
        var l, s, r, c, p, d, m, u, f, v, g, _, h, x, b, y, w, C, L, H, k, M, V, z, j, A, E, I, T, S, O, Z, R, D, P, F, N, B, W, X, Y, G, K, J, Q, $, ee, te, ie, ae, ne, oe = {
            x: 0,
            y: 0
        }, le = {
            x: 0,
            ...
            J && !n.currItem.loadError && (e && (v > n.currItem.fitRatio ? ve || (Wt(n.currItem, !1, !0),
            ve = !0) : ve && (Wt(n.currItem),
            ve = !1)),
            Ce(J, se.x, se.y, v))
        }, He = function(e) {
            ...
            init: function() {
                if (!l && !s) {
                    ...
                    xe("initialZoomInEnd", (function() {
                        ...
                        E.is_mouse ? Ae() : U.is_pointer && ce.bind(document, "mousemove", Ie),
            ...
            updateCurrZoomItem: function(e) {
                ...
                J = t.length && t[0].classList.contains("pswp__zoom-wrap") ? t[0].style : null,
                K = n.currItem.bounds,
            ...
            zoomTo: function(e, t, i, a, n) {
                ...
                i ? We("customZoomTo", 0, 1, i, a || ce.easing.sine.inOut, p) : p(1)
            }
        }, Ye = {}, Ge = {}, Ke = {}, Je = {}, Qe = {}, $e = [], et = {}, tt = [], it = {}, at = 0, nt = {
            x: 0,
            y: 0
        }, ot = 0, lt = {
            x: 0,
            ...
            r = se[e] + t[e] * i,
            (o.allowPanToNext || v === n.currItem.initialZoomLevel) && (J ? "h" !== $ || "x" !== e || F || (c ? (r > K.min[e] && (i = o.panEndFriction,
            K.min[e] - r,
            a = K.min[e] - le[e]),
            (a <= 0 || d < 0) && Zt() > 1 ? (s = p,
            ...
            "x" === e))
                ...
                W = s !== et.x),
                K.min.x !== K.max.x && (void 0 !== l ? se.x = l : W || (se.x += t.x * i)),
                void 0 !== s;
                ...
                if (0 !== e)
                    ...
                    Y && e > 1) {
                        ...
                        if (!$)
                            return;
                        if (ee && (ee = !1,
                        Math.abs(Ke.x) >= 10 && (Ke.x -= X[0].x - Qe.x),
                        Math.abs(Ke.y) >= 10 && (Ke.y -= X[0].y - Qe.y)),
                        Je.x = Ye.x,
                        Je.y = Ye.y,
                        0 === Ke.x && 0 === Ke.y)
                            return;
            ...
            N || F || Q || R)
                ...
                R) {
                    if (_t() < o.verticalDragRange)
                        ...
                        var c = se.y
                          , p = ie;
                        We("verticalDrag", 0, 1, 300, ce.easing.cubic.out, (function(e) {
                    ...
                    Q || ("swipe" === a ? !W && v > n.currItem.fitRatio && Vt(O) : At())
                }
        }, Mt = function() {
            var e, t, i = {
                lastFlickOffset: {},
                ...
                calculateOverBoundsAnimOffset: function(e, t) {
                    ...
                    We("bounceZoomPan" + e, se[e], i.backAnimDestination[e], t || 300, ce.easing.sine.out, (function(t) {
                        se[e] = t,
                        Le()
                    }
                    )))))
            ...
            We("mainScroll", lt.x, d, p, ce.easing.cubic.out, Me, (function() {
                Be(),
                Q = !1,
                at = -1,
                ...
                a) {
                    var i = s.w / t.w
                      ...
                      , r = function(t) {
                        1 === t ? (v = i,
                        se.x = s.x,
                        se.y = s.y - A) : (v = (i - o) * t + o,
                        se.x = (s.x - n.x) * t + n.x,
                        se.y = (s.y - A - n.y) * t + n.y),
                        Le(),
                        u ? e.style.opacity = 1 - t : we(l - t * l)
                    };
                    m ? We("initialZoom", 0, 1, p, ce.easing.cubic.out, r, d) : (r(1),
                            ...
                            s.loadComplete = function(i) {
                                if (l) {
                                    if (e && e.index === t) {
                                        ...
                                        i.placeholder = null) : Q || St ? Pt.push({
                                            item: i,
                                            baseDiv: r,
                                            img: i.img,
                                            index: t,
        ...
        var Yt, Gt, Kt = {}, Jt = function(e, t, i) {
    ...
    function de() {
        ...
        !_c.prevent_right_click && _c.context_menu && (N.files_container && N.files_container.addEventListener("contextmenu", (function(e) {
            var t = e.target.closest(".files-a");
            P.create_contextmenu(e, "files", t || N.files_container, t ? _c.files[t.dataset.name] : _c.current_dir)
        }
        )),
        N.sidebar_menu && N.sidebar_menu.addEventListener("contextmenu", (function(e) {
            var t = e.target.closest(".menu-li");
            P.create_contextmenu(e, "sidebar", t || N.sidebar_menu, _c.dirs[t ? t.dataset.path : ""])
        }
        ))),
        anime({
    ...
    !function() {
        if (_c.menu_exists) {
            ...
            var e, a, n, o, l, r = !1, c = !1, p = {}, d = !1, m = E.get_json("files:interface:menu-expanded:" + _c.location_hash), u = _c.menu_show && matchMedia("(min-width: 992px)").matches;
            ...
            y(N.sidebar_toggle, x, "click"),
            y(N.sidebar_modal, x, "click"),
            P.create_menu = V;
            ...
            !(!f || v && !function() {
                for (var e = f.length, t = 0; t < e; t++)
                    if (f[t].path.includes("/"))
                        return !1;
                return !0
            }()) ? V(f, "menu from localstorage [" + (_c.menu_cache_validate ? "shallow menu" : "menu cache validation disabled") + "]") : (N.sidebar_menu.classList.add("sidebar-spinner"),
            ...
            I({
                ...
                complete: function(e, t, i) {
                    ...
                    e.localstorage ? V(f, "menu from localstorage") : (V(e, "menu from " + (_c.menu_cache_file ? "JSON cache: " + _c.menu_cache_file : "xmlhttp")),
        ...
        function M(e, a) {
            ...
            '<li data-level="' + l + '" data-path="' + t(e.path) + '" class="' + n + '"><a href="' + s(e) + '" class="' + o + '">' + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-toggle", "plus", "minus") : "") + (a ? P.get_svg_icon_multi_class("menu-icon menu-icon-folder menu-icon-folder-toggle", r, "folder_plus", "folder_minus") : P.get_svg_icon_class(r, "menu-icon menu-icon-folder")) + i(e.basename) + "</a>"
        }
        function V(t, i) {
            var s, r;
            if (K(),
            ...
            function(e) {
                ...
                k(e, (function(e, o) {
                    ...
                    if (l) {
                        ...
                        a += r,
                        n && (t += M(n, r > 0)),
                        t += r > 0 ? '<ul style="--depth:' + (a - 1) + '" class="menu-' + (n ? "ul" : "root") + '">' : "</li>" + C("</ul></li>", -r),
                        n = _c.dirs[l]
                    }
                }
                )),
                t += M(n, !1) + C("</li></ul>", a),
                N.sidebar_menu.innerHTML = t
            }(t),
            ...
            y(e = N.sidebar_topbar.lastElementChild, (function(e) {
                if (d) {
                    ...
                    k(o, (function(e) {
                        if (e.classList.contains("menu-li-open"))
                            if (a)
                                ...
                                n.top > s || n.bottom - n.top > 2 * s ? (t.push(e),
                                a = !0) : i.push(e)
                            }
                    }
                    )),
                    ...
                    n.length > 100 ? L(n, "menu-li-open", !0) : (t = [],
                    i = [],
                    a = !1,
                    s = window.innerHeight,
                    k(n, (function(e) {
                        e.classList.contains("menu-li-open") || (a || !e.offsetParent ? t.push(e) : e.getBoundingClientRect().top > s || e.lastChild.childNodes.length > 50 ? (a = !0,
                        t.push(e)) : i.push(e))
                    }
                    )),
                    t.length && k(t, (function(e) {
            ...
            _c.transitions && u) {
                ...
                m.delay = anime.stagger(O(20, 50, Math.round(200 / m.targets.length))),
                anime(m)
            }
            y(a, (function(e) {
                if (q.contextmenu.is_open)
                    return e.preventDefault();
                if (e.target !== a) {
                    var t, i, n, o, l = "A" === e.target.nodeName, s = l ? e.target.parentElement : e.target.closest(".menu-li"), r = l ? e.target : s.firstElementChild;
                    if (!b(e, r))
                        if (l && r !== c)
                            P.get_files(s.dataset.path, "push"),
                            matchMedia("(min-width: 992px)").matches ? _c.menu_show || (t = N.sidebar,
                            i = "sidebar-clicked",
                            n = null,
                            o = 1e3,
                            t.classList.add(i),
    ...
    function() {
        ...
        function l(e, t) {
            if (_c.sort_dirs_first && e._values.is_dir !== t._values.is_dir)
                return (t._values.is_dir ? 1 : -1) * q.sort.multi;
            var i = e._values[q.sort.prop]
              , a = t._values[q.sort.prop];
            return "name" === q.sort.sort || i === a ? c(e._values.basename, t._values.basename) : i > a ? 1 : -1
        }
        var s = {
            locale: function(e, t) {
                return r.compare(e, t) || sort_methods.basic(e, t)
            },
            basic: function(e, t) {
                var i = e.toLowerCase()
                  , a = t.toLowerCase();
        ...
        function p(e, t, i) {
            ...
            m[q.sort.index].classList[a]("sortbar-active")),
            (e || t) && (o[q.sort.index].classList[a]("sort-" + q.sort.order),
            m[q.sort.index].classList[a]("sort-" + q.sort.order))
        }
        ...
        var m = N.sortbar.firstChild.children;
    ...
    function() {
        ...
        X.dropdown(),
        _c.has_login) {
            N.topbar_top.insertAdjacentHTML("beforeend", '<a href="' + location.href.split("?")[0] + '?logout" class="btn-icon btn-topbar" id="logout"' + h("logout", !0) + ">" + P.get_svg_icon("logout") + "</a>");
    ...
    "IntersectionObserver"in window && "IntersectionObserverEntry"in window && "intersectionRatio"in window.IntersectionObserverEntry.prototype ? de() : P.load_plugin("intersection-observer", de, {
